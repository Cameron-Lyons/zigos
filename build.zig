...
pub fn build(b: *std.Build) void {
    ...
    const userland_smoke_test_cmd = b.addSystemCommand(&.{
        ...
        \\  exit 1
        \\fi
        \\for marker in "BOOT:START" "BOOT:PROFILE:userland_smoke" "Disk root mounted at /" "BOOT:SHELL_READY" "USERLAND:HELLO" "USERLAND:ECHO" "USERLAND:UNAME" "USERLAND:LS" "USERLAND:CAT" "Welcome to ZigOS userspace smoke test." "USERLAND:PASS"; do
