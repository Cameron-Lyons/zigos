...
for marker in "BOOT:START" "BOOT:ROLE:${EXPECTED_ROLE}" "ZIGOS:CPU:BASELINE:MODERN_X86_64:READY" "ZIGOS:CPU:NX:ENABLED" "ZIGOS:CPU:PCID:READY" "ZIGOS:KERNEL:W_X:ENFORCED" "Welcome to Zigos" "Initializing GDT" "BOOT:CORE_READY"; do
