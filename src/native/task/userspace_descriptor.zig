...
pub fn init(spec: InitSpec) InitError!Descriptor {
    ...
    descriptor.bundle_id_len = @intCast(native_util.copyTextExact(descriptor.bundle_id[0..], spec.bundle_id) catch return error.BundleIdTooLong);
    descriptor.display_name_len = @intCast(native_util.copyTextExact(descriptor.display_name[0..], spec.display_name) catch return error.DisplayNameTooLong);
    descriptor.label_len = @intCast(native_util.copyTextExact(descriptor.label[0..], spec.label) catch return error.LabelTooLong);
    descriptor.entry_len = @intCast(native_util.copyTextExact(descriptor.entry[0..], spec.entry) catch return error.EntryTooLong);
    descriptor.publisher_len = @intCast(native_util.copyTextExact(descriptor.publisher[0..], spec.publisher) catch return error.PublisherTooLong);
