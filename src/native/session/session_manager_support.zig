...
pub const NotesPhaseState = struct {
    task_id: u64,
    ...
    pub fn grantsSlice(self: *const NotesPhaseState) []const policy_mediation.UserGrant {
        return self.grants[0..self.grants_len];
    }
};

pub const Phase3Bindings = struct {
    bindings: [service_contract.ordered_phase3_contracts.len]phase3_bootstrap.ServiceBinding,

    pub fn bindingFor(self: *const Phase3Bindings, class: contract.ServiceClass) phase3_bootstrap.ServiceBinding {
