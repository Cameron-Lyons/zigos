...
pub const HEAP_BACKED_RECOVERABLE_DELETE_LOGS_ON_FREESTANDING = directory.HEAP_BACKED_RECOVERABLE_DELETE_LOGS_ON_FREESTANDING;
pub const recoverable_delete_layout = directory.recoverable_delete_layout;
pub const HEAP_BACKED_WORKSPACE_SHARE_TABLES_ON_FREESTANDING = directory.HEAP_BACKED_WORKSPACE_SHARE_TABLES_ON_FREESTANDING;
pub const workspace_share_table_layout = directory.workspace_share_table_layout;
pub const HEAP_BACKED_WORKSPACE_ENTRIES_ON_FREESTANDING = directory.HEAP_BACKED_WORKSPACE_ENTRIES_ON_FREESTANDING;
pub const workspace_entry_layout = directory.workspace_entry_layout;
