...
pub const DERIVES_OBJECT_STORE_RECORD_ARENA_KEYS_FROM_PAYLOADS = store.DERIVES_OBJECT_STORE_RECORD_ARENA_KEYS_FROM_PAYLOADS;
pub const DERIVES_VERSION_ADDRESS_FROM_CANONICAL_STATE = store.DERIVES_VERSION_ADDRESS_FROM_CANONICAL_STATE;
pub const RETURNS_SINGLE_CHUNK_PAYLOADS_WITHOUT_COPIES = store.RETURNS_SINGLE_CHUNK_PAYLOADS_WITHOUT_COPIES;
pub const RIGHT_SIZES_OBJECT_STORE_DIRTY_ID_INDEXES = store.RIGHT_SIZES_OBJECT_STORE_DIRTY_ID_INDEXES;
