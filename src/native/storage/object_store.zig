...
pub const OBJECT_SNAPSHOT_STATE_SIZE_CEILING_BYTES = store.OBJECT_SNAPSHOT_STATE_SIZE_CEILING_BYTES;
pub const OBJECT_SYNC_STATE_SIZE_CEILING_BYTES = store.OBJECT_SYNC_STATE_SIZE_CEILING_BYTES;
