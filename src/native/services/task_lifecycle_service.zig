...
pub const Service = struct {
    ...
    pub fn control(
        ...
        const transitioned = switch (request.operation) {
            .suspend_task => try self.runtime.suspendTask(request.task_id, request.now_ticks),
            .resume_task => try self.runtime.resumeTask(request.task_id, request.now_ticks),
            .terminate_task => try self.runtime.terminateTask(request.task_id, request.now_ticks),
        };
