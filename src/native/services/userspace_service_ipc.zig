...
const SESSION_TASK_MEMORY_BYTES: usize = 4096;
const SESSION_TASK_ENDPOINT_SLOTS: u16 = 8;
const SESSION_TASK_SHARED_MEMORY_BYTES: usize = 4096;
const SERVICE_TASK_CPU_TICKS: u64 = 6_000;
const SERVICE_TASK_MEMORY_BYTES: usize = 256 * 1024;
const SERVICE_TASK_ENDPOINT_SLOTS: u16 = 8;
const SERVICE_TASK_SHARED_MEMORY_BYTES: usize = 16 * 1024;
