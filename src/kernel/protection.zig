...
// Verify that a user pointer is valid and within user space
pub fn verifyUserPointer(ptr: usize, size: usize) bool {
    ...
    // Check that the pages are mapped
...
pub fn copyFromUser(kernel_dest: []u8, user_src: usize) !void {
    ...
    // Temporarily disable interrupts to prevent race conditions
