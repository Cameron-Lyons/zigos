...
test "kernel-launched userspace images surface a userspace task flag" {
    ...
    var runtime = task_runtime.Runtime.init();
    var capabilities = @import("capability.zig").CapabilityTable.init();
    var endpoints = @import("endpoint.zig").Table.init();
    var shared = @import("shared_memory.zig").Table.init();
    var registry = @import("service_registry.zig").Registry.init();
    var kernel = @import("native_kernel.zig").Kernel.init(
