...
const syscall_at = @import("at.zig");
const syscall_cwd = @import("cwd.zig");
const syscall_event = @import("event.zig");
const syscall_fd = @import("fd.zig");
const syscall_fs = @import("fs.zig");
const syscall_io = @import("io.zig");
const syscall_ipc = @import("ipc.zig");
const syscall_misc = @import("misc.zig");
const syscall_net = @import("net.zig");
const syscall_process = @import("process_ops.zig");
const syscall_process_state = @import("process_state.zig");
const syscall_readiness = @import("readiness.zig");
const syscall_resource = @import("resource.zig");
const trap = @import("../../../shared/syscall_trap.zig").kernel;
const syscall_signal = @import("signal.zig");
const support = @import("support.zig");
const syscall_system = @import("system.zig");
...
pub const SYS_SPAWN_WITH_FDS = abi.SYS_SPAWN_WITH_FDS;
...
fn sys_spawn_with_fds(path: [*]const u8, argv: usize, envp: usize, stdio_addr: usize) i32 {
    return syscall_process.sys_spawn_with_fds(path, argv, envp, stdio_addr);
}
...
export fn syscall_handler(regs: *idt.InterruptRegisters) callconv(.c) void {
    ...
    const result = switch (syscall_num) {
        ...
        SYS_SPAWN_WITH_FDS => sys_spawn_with_fds(@as([*]const u8, @ptrFromInt(arg1)), arg2, arg3, arg4),
