...
const SYSCALL_BENCHMARK_CODE_ADDRESS: usize = 0x4000_0000;
const SYSCALL_BENCHMARK_STACK_ADDRESS: usize = 0x0000_007F_FFFF_E000;
const SYSCALL_BENCHMARK_PAGE_BYTES: usize = 4096;
