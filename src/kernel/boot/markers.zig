...
pub const service_boot_storage_timeout_propagated = "ZIGOS:SERVICE_BOOT:DRIVER:STORAGE_TIMEOUT_PROPAGATED";
...
pub const service_boot_storage_broker_revoke_rejected = "ZIGOS:SERVICE_BOOT:DRIVER:BROKER_REVOKE_REJECTED";
