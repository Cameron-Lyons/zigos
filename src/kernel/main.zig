...
fn userlandSmokeRunner() callconv(.c) void {
    ...
    const commands = [_]struct {
        ...
        .{ .command = "cd /bin", .marker = "USERLAND:CD_BIN" },
        .{ .command = "./echo USERLAND:RELATIVE", .marker = "USERLAND:RELATIVE_CMD" },
        .{ .command = "cd /etc", .marker = "USERLAND:CD_ETC" },
        .{ .command = "/bin/cat motd", .marker = "USERLAND:RELATIVE_ARG" },
        .{ .command = "cd /", .marker = "USERLAND:CD_ROOT" },
